...
0==a&&b&&b(!0)};
window.__onGCastApiAvailable=c;yHa("//www.gstatic.com/cast/sdk/libs/sender/1.0/cast_framework.js",t6,c)}},CHa=function(){BHa();
...
a.Ve&&(c=null);var d=(0,g.z)(a.ZQ,a);c||(c=new g.Zm("//www.google.com/images/cleardot.gif"),$5(c));QHa(c.toString(),1E4,d)}else B6(2);nIa(a,b)},nIa=function(a,b){a.Ha=0;
...
c&&(c.receiverType!=chrome.cast.ReceiverType.CUSTOM&&(c=new chrome.cast.Receiver(c.label,c.friendlyName),c.receiverType=chrome.cast.ReceiverType.CUSTOM),a.push(c));return a},YIa=function(a,b,c,d,e,f,h){TIa()?UIa(b,e,f,h)&&(J7(!0),window.chrome&&chrome.cast&&chrome.cast.isAvailable?VIa(a,c):(window.__onGCastApiAvailable=function(l,m){l?VIa(a,c):(K7("Failed to load cast API: "+m),L7(!1),J7(!1),g.Ys("yt-remote-cast-available"),g.Ys("yt-remote-cast-receiver"),WIa(),c(!1))},d?g.So("https://www.gstatic.com/cv/js/sender/v1/cast_sender.js"):
